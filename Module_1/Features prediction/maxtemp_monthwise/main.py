...
df = pd.read_csv('Maximum temperature_1901-2002.csv')
finale = pd.DataFrame()
dis_arr = np.array(df['District'].unique())
dis_arr1 = dis_arr[0:2]
dataset = tf.data.Dataset.from_tensor_slices(dis_arr)
...
finale.to_csv('max_temp_predictions.csv', index=False)"""
